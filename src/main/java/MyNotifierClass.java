...
public class MyNotifierClass {
    private final NotificationGroup NOTIFICATION_GROUP = new NotificationGroup("Plugin informations", NotificationDisplayType.BALLOON, true);
